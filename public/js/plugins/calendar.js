...
const Heading = ({
    ...
    onClick: () => resetDate()
  }, date.format('MMMM'), " ", /*#__PURE__*/React.createElement("small", null, date.format('YYYY'))), /*#__PURE__*/React.createElement("a", {
    onClick: () => changeMonth(date.month() + 1)
  }, "\u203A"));
  ...
  const Days = ({
    ...
    for (let i = 1; i <= 7; i++) {
      labels.push( /*#__PURE__*/React.createElement("span", {
        className: "label"
  ...
  ReactDOM.render( /*#__PURE__*/React.createElement(Calendar, null), document.getElementById('calendar'));
  /**CELENDAR====================================== */